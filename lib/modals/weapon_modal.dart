class WeaponModal {
  ...
  WeaponModal(
      {this.name, this.type, this.rarity, this.baseAttack, this.subStat, this.passiveName, this.passiveDesc, this.location, this.ascensionMaterial});

  WeaponModal.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    type = json['type'];
    rarity = json['rarity'];
